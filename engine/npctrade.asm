...
ENDM
	...
	npctrade 0, NIDORINA,   PORYGON,    "PO@@@@@@@@@", $37, $66, UP_GRADE,     37460, "MICHAEL@@@@", TRADE_EITHER_GENDER
    npctrade 0, GROWLITHE,  POLIWHIRL,  "POLYBOLY@@@", $96, $66, KINGS_ROCK,   48926, "TIM@@@@@@@@", TRADE_EITHER_GENDER
    npctrade 1, RATICATE,   SEADRA,     "DRAINY@@@@@", $98, $88, DRAGON_SCALE, 29189, "ERIC@@@@@@@", TRADE_EITHER_GENDER
    npctrade 3, PIDGEOTTO,  HAUNTER,    "HARRY@@@@@@", $77, $66, SPELL_TAG,    00283, "EMMA@@@@@@@", TRADE_EITHER_GENDER
    npctrade 2, FEAROW,     KADABRA,    "KADAVER@@@@", $96, $86, TWISTEDSPOON, 15616, "DUANE@@@@@@", TRADE_EITHER_GENDER
    npctrade 3, FURRET,     SCYTHER,    "SLICER@@@@@", $96, $66, METAL_COAT,   26491, "KATHY@@@@@@", TRADE_EITHER_GENDER
    npctrade 0, DUGTRIO,    SLOWPOKE,   "DUH@@@@@@@@", $96, $66, KINGS_ROCK,   50082, "BOB@@@@@@@@", TRADE_EITHER_GENDER
	; fcf38
