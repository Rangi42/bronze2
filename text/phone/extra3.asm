UnknownText_0x174000: ; 0x174000
	...
	para "yourself to be on"
	line "an episode of my"
	cont "show!"
	
	para "I'm working with"
	line "a director in"
	
	para "CASCADE CITY and"
	line "I reccomended you"
	cont "for the part."
	
	para "Come and drop by,"
	line "the CASCADE CITY"
	
	para "STUDIOS and you'll"
	line "even get something"
