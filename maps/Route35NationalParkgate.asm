...
UnknownText_0x6a894:
	text "Boy I wish I could"
	line "keep watch inside"
	cont "the park."
	
	para "It's beautiul out"
	line "there."
	
	para "But instead I"
	line "gotta be couped up"
	cont "in here all week."
	done

UnknownText_0x6a8d8:
	text "FELONWOOD PARK is"
	line "a lovely place."
	
	para "Many people use"
	line "it for dates!"
	cont "Heh heh heh."
	done
...
.Warps: db 4
	warp_def 0, 4, 3, NATIONAL_PARK
	warp_def 0, 5, 4, NATIONAL_PARK
	warp_def 7, 4, 2, ROUTE_39
	warp_def 7, 5, 2, ROUTE_39

.CoordEvents: db 0

.BGEvents: db 1
	signpost -2, 6, SIGNPOST_READ, MapRoute36NationalParkgateSignpost0Script

.ObjectEvents: db 3
	person_event SPRITE_OFFICER, -5, -5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, OfficerScript_0x6a204, -1
	person_event SPRITE_YOUNGSTER, 4, 6, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, YoungsterScript_0x6a2d8, -1
	person_event SPRITE_OFFICER, 3, 0, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, OfficerScript_0x6a2ca, -1
