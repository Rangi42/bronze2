...
UnknownText_0x71ec1:
	text "BRANDIES CITY"
	line "was built on top"
	
	para "of a hill to avoid"
	line "flooding."
	done
...
.PersonEvents:
	...
	person_event SPRITE_POKEFAN_M, 3, 0, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, PharmacistScript_0x71e2b, -1
	...
	person_event SPRITE_SUPER_NERD, -5, -5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, CeladonEusine, -1
