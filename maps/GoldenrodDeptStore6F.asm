const_value set 2
	...
	const GOLDENRODDEPTSTORE6F_JIGGLYPUFF
...
DeptStoreJigglyPuff
	opentext 
	writetext DeptStoreJigglyPuffText
	cry JIGGLYPUFF
	waitbutton
	closetext
	end

DeptStoreJigglyPuffText:
	text "JIGGLYPUFF:"
	line "PIIPUU! PUU!"
	done
...
.PersonEvents:
	db 3
	person_event SPRITE_SUPER_NERD, 2, 10, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, LassScript_0x564bf, -1
	person_event SPRITE_TWIN, 2, 8, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, SuperNerdScript_0x564c2, -1
	person_event SPRITE_JIGGLYPUFF, 1, 7, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, DeptStoreJigglyPuff, -1
