...
.Warps: db 5
	...
	warp_def 15, 18, 1, SPROUT_TOWER_2F
...
.ObjectEvents: db 6
	...
	person_event SPRITE_BLACK_BELT, 15, 17, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_TRAINER, 4, TrainerSageChow, -1
