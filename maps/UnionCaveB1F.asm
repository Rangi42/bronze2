...
.Warps: db 5
	...
	warp_def 19, 7, 1, UNION_CAVE_1F
	warp_def 31, 7, 1, UNION_CAVE_1F
	warp_def 31, 17, 2, UNION_CAVE_1F
...
.ObjectEvents: db 7
	...
	person_event SPRITE_SUPER_NERD, 20, 5, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerPokemaniacAndrew, -1
	person_event SPRITE_SUPER_NERD, -4, -4, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerPokemaniacCalvin, -1
