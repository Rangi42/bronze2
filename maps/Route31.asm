...
Route31CooltrainerMText:
	text "I'm not here to"
	line "battle."
	
	para "I just love find-"
	line "ing ITEM BALLS!"
	done

Bug_catcherWade1SeenText:
	text "I'll show you why"
	line "bugs are superior!"
...
.Warps: db 3
	warp_def 10, 4, 3, ROUTE_31_VIOLET_GATE
	warp_def 11, 4, 4, ROUTE_31_VIOLET_GATE
	warp_def 5, 34, 1, DARK_CAVE_VIOLET_ENTRANCE

.CoordEvents: db 0

.BGEvents: db 2
	signpost 7, 19, SIGNPOST_READ, Route31Sign
	signpost 4, 33, SIGNPOST_READ, DarkCaveSign

.ObjectEvents: db 7
	person_event SPRITE_FISHER, -7, 19, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31MailRecipientScript, -1
	person_event SPRITE_YOUNGSTER, 8, 21, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31YoungsterScript, -1
	person_event SPRITE_BUG_CATCHER, 16, 14, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_TRAINER, 5, TrainerBug_catcherWade1, -1
	person_event SPRITE_COOLTRAINER_M, 8, 35, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31CooltrainerMScript, -1
	person_event SPRITE_FRUIT_TREE, 1, 21, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route31FruitTree, -1
	person_event SPRITE_POKE_BALL, 15, 33, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, Route31Potion, EVENT_ROUTE_31_POTION
