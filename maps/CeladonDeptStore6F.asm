...
UnknownText_0x712c7:
	...
	para "My #MON love"
	line "them too."
	cont "We always share!"
	done

UnknownText_0x71310:
	text "Hi!"
	line "I love SODA POP!"
	
	para "MOM says the sugar"
	line "isn't good for me."
	
	para "But how can some-"
	line "thing that tastes"
	
	para "so good be bad for"
	line "me?"
	done
...
.PersonEvents:
	...
	person_event SPRITE_BUG_CATCHER, 5, 12, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, YoungsterScript_0x7117d, -1
