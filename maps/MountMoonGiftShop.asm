...
MountMoonGiftShop_MapEventHeader:: db 0, 0

.Warps: db 2
	warp_def 7, 3, 3, MOUNT_MOON_SQUARE
	warp_def 7, 2, 3, MOUNT_MOON_SQUARE
...
.ObjectEvents: db 4
	person_event SPRITE_GRAMPS, 2, 4, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, 1, 0, PERSONTYPE_SCRIPT, 0, GrampsScript_0x771a8, -1
	...
	person_event SPRITE_LASS, 2, 8, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, 2, 0, PERSONTYPE_SCRIPT, 0, LassScript_0x771b0, -1
