...
UnknownText_0x19b130:
	text "A JANTO kid, huh?"
	line "Well it's nice to"
	
	para "meet someone from"
	line "so far away!"
	done
...
BluesHouse_MapEventHeader:: db 0, 0
...
.ObjectEvents: db 1
	person_event SPRITE_COOLTRAINER_F, 3, 2, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, DaisyScript_0x19b0d0, -1
