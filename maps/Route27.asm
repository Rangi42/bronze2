...
Route27SignFreako:
	jumptext Route27SignFreakoText
...
UnknownText_0x1a0a71:
	...
	para "Because that's"
	line "where this route"
	cont "leads!"
	
	para "Only the strongest"
	line "trainers should"
	
	para "attempt heading"
	line "out there!"
	done
...
.Warps: db 3
	warp_def 1, 43, 1, ROUTE_27_SANDSTORM_HOUSE
	warp_def 12, 2, 4, VICTORY_ROAD_GATE
	warp_def 13, 2, 3, VICTORY_ROAD_GATE

.CoordEvents: db 2
	xy_trigger 0, -7, 36, 0, UnknownScript_0x1a0873, 0, 0
	xy_trigger 0, -7, 37, 0, UnknownScript_0x1a0881, 0, 0

.BGEvents: db 2
	signpost 11, 5, SIGNPOST_READ, TohjoFallsSign
	signpost 9, 39, SIGNPOST_READ, Route27SignFreako

.ObjectEvents: db 9
	person_event SPRITE_COOLTRAINER_M, -6, 33, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_TRAINER, 3, TrainerCooltrainermBlake, -1
	person_event SPRITE_COOLTRAINER_M, -6, 32, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_TRAINER, 4, TrainerCooltrainermBrian, -1
	person_event SPRITE_COOLTRAINER_F, -6, 35, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_TRAINER, 4, TrainerCooltrainerfReena, -1
	person_event SPRITE_COOLTRAINER_F, -6, 30, SPRITEMOVEDATA_SPINCLOCKWISE, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_TRAINER, 2, TrainerCooltrainerfMegan, -1
	person_event SPRITE_YOUNGSTER, -6, 34, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerPsychicGilbert, -1
	person_event SPRITE_YOUNGSTER, -6, 31, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerBird_keeperJose2, -1
	person_event SPRITE_POKE_BALL, 5, 7, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, Route27TMSolarbeam, EVENT_ROUTE_27_TM_SOLARBEAM
	person_event SPRITE_POKE_BALL, 23, 32, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, Route27RareCandy, EVENT_ROUTE_27_RARE_CANDY
	person_event SPRITE_FISHER, 10, 35, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 1, -1, -1, 0, PERSONTYPE_SCRIPT, 3, FisherScript_0x1a089c, -1
