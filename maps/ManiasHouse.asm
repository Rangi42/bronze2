...
ManiaScript:
	faceplayer
	opentext
	writetext MianiaGenericSpeechText
...
MianiaGenericSpeechText:
	text "Have you ever"
	line "been in love,"
	cont "child?"
	
	para "I had a husband"
	line "for at least 55"
	cont "years."
	
	para "once you find the"
	line "one, you stick"
	cont "with them."
...
.PersonEvents:
	db 1
	person_event SPRITE_GRANNY, 4, 2, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, ManiaScript, -1
