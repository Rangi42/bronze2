...
UnknownText_0x62105:
	...
	para "identity here"
	line "remains a secret."
	
	para "They must be some-"
	line "one important."
	done
...
UnknownText_0x62260:
	text "I saw PROF. ALDER"
	line "being interviewed"
	cont "on TV."
	
	para "He said he gave"
	line "two young trainers"
	
	para "their first"
	line "#MON, so they"
	
	para "could make their"
	line "mark on this"
	cont "world."
...
.PersonEvents:
	...
	person_event SPRITE_POKEFAN_M, 2, 6, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, GameboyKidScript_0x6101e, -1
	person_event SPRITE_POKEFAN_F, 4, 1, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 1, -1, -1, 0, PERSONTYPE_SCRIPT, 0, LassScript_0x61021, -1
	person_event SPRITE_LASS, 5, 6, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, PokefanFScript_0x61024, -1
