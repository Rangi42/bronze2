...
BlackLostKidsTrigger1
	...
	waitbutton
	writetext BlackRivalBattleText
	waitbutton
	writetext BlackRivalText2
	waitbutton
	closetext
...
BlackLostKidsTrigger2Top
	...
	playmusic MUSIC_RIVAL_ENCOUNTER
	showemote EMOTE_SHOCK, PLAYER, 15
	applymovement BLACKTHORNGATES_RIVAL, BlackRivalMovement1Top
...
BlackGateSkipToBattle
	dotrigger $1
	appear BLACKTHORNGATES_RIVAL
	disappear BLACKTHORNGATES_TEACHER
	disappear BLACKTHORNGATES_BUENA
	disappear BLACKTHORNGATES_POKEFAN_M
	disappear BLACKTHORNGATES_POKEFAN_F
	opentext
	writetext BlackSkipToBattleText
	waitbutton
	closetext
	end
...
BlackRivalText1:
	...
	line "It'll really show"
	
	para "me if you have"
	line "what it takes."
	done
	
BlackRivalBattleText:
	text "INSERT BATTLE HERE"
	done
...
BlackSkipToBattleText:
	text "Cutscene skipped."
	line "Rival battle"
	cont "enabled."
	done
...
.CoordEvents: db 3
	...
	xy_trigger 1, 4, 2, 0, BlackLostKidsTrigger2Top, 0, 0
	xy_trigger 1, 5, 2, 0, BlackLostKidsTrigger2Bottom, 0, 0

.BGEvents: db 2
	signpost 10, 8, SIGNPOST_READ, BlackGateUndergroundSign
	signpost 1, 1, SIGNPOST_READ, BlackGateSkipToBattle
