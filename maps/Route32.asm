;
; ROAR guy needs to be given text and a new ITEM
;
...
YoungsterAlbertAfterText:
	text "I thought I recog"
	line "-nised you from"
	cont "TV or something."

	para "I hope I can meet"
	line "someone famous one"
	cont "day!"
	done
...
CamperRolandAfterText:
	text "Losing is hard,"
	line "but you get much"
	
	para "stronger when you"
	line "battle other"
	cont "trainers."
	done

PicnickerLiz1SeenText:
	text "Being in the out-"
	line "doors, there's"
	cont "nothing like it."
	done
...
PicnickerLiz1AfterText:
	text "I should meet up"
	line "with my camping"
	cont "buddies."
	done
...
.Warps: db 7
	...
	warp_def 55, 9, 1, ROUTE_34_ILEX_FOREST_GATE
	warp_def 1, 9, 3, ECRUTEAKGATES
	warp_def 55, 10, 2, ROUTE_34_ILEX_FOREST_GATE

.CoordEvents: db 2
	xy_trigger 0, 17, 0, 0, Route32CooltrainerMStopsYou, 0, 0
	xy_trigger 1, 71, 7, 0, Route32WannaBuyASlowpokeTailScript, 0, 0

.BGEvents: db 6
	signpost 48, 8, SIGNPOST_READ, Route32Sign
	signpost 0, 4, SIGNPOST_READ, Route32RuinsSign
	signpost 82, 10, SIGNPOST_READ, Route32UnionCaveSign
	signpost 73, 12, SIGNPOST_READ, Route32PokeCenterSign
	signpost 67, 12, SIGNPOST_ITEM, Route32HiddenGreatBall
	signpost 32, 12, SIGNPOST_ITEM, Route32HiddenSuperPotion

.ObjectEvents: db 14
	person_event SPRITE_FISHER, 64, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_TRAINER, 1, TrainerFisherJustin, -1
	person_event SPRITE_FISHER, 64, 6, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_TRAINER, 3, TrainerFisherRalph1, -1
	person_event SPRITE_FISHER, 64, 7, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_TRAINER, 1, TrainerFisherHenry, -1
	...
	person_event SPRITE_YOUNGSTER, 64, 4, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_TRAINER, 3, TrainerYoungsterGordon, -1
	person_event SPRITE_YOUNGSTER, 50, 11, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_TRAINER, 4, TrainerCamperRoland, -1
	person_event SPRITE_LASS, 34, 0, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_TRAINER, 3, TrainerPicnickerLiz1, -1
	person_event SPRITE_COOLTRAINER_M, 17, 1, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route32CooltrainerMScript, -1
	...
	person_event SPRITE_POKE_BALL, 52, 4, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, Route32GreatBall, EVENT_ROUTE_32_GREAT_BALL
	person_event SPRITE_FISHER, 1, 13, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, Route32RoarTMGuyScript, -1
	...
	person_event SPRITE_POKE_BALL, 17, 7, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, Route32Repel, EVENT_ROUTE_32_REPEL
