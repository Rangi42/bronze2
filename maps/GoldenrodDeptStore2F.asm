...
UnknownText_0x55cb7:
	...
	para "SUPER POTION into"
	line "the air."
	
	para "Although it"
	line "smells great, your"
...
.PersonEvents:
	...
	person_event SPRITE_ROCKER, 2, 6, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 0, 2, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, CooltrainerFScript_0x55b70, -1
	person_event SPRITE_ROCKER, 6, 2, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, GentlemanScript_0x55b73, -1
