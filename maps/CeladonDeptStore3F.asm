...
UnknownText_0x70d53:
	text "It's a bit hard"
	line "for me to decide"
	
	para "which TM I need"
	line "the most."
	done
...
UnknownText_0x70e61:
	text "I've got plenty"
	line "of smooth moves"
	cont "for my #MON!"
	done
...
.PersonEvents:
	...
	person_event SPRITE_YOUNGSTER, 6, 6, SPRITEMOVEDATA_WALK_UP_DOWN, 1, 0, -1, -1, (1 << 3) | PAL_OW_GREEN, PERSONTYPE_SCRIPT, 0, YoungsterScript_0x70d31, -1
	person_event SPRITE_GAMEBOY_KID, -6, -6, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_RED, PERSONTYPE_SCRIPT, 0, GameboyKidScript_0x70d34, -1
	person_event SPRITE_GAMEBOY_KID, -6, -7, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, GameboyKidScript_0x70d3f, -1
	person_event SPRITE_SUPER_NERD, 4, 13, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, SuperNerdScript_0x70d4a, -1
