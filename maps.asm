...
SECTION "maps/second_map_headers.asm", ROMX
...
INCLUDE "maps/Route41.asm" ;MOVED FROM 22
...
SECTION "GoldenrodcityGates", ROMX
INCLUDE "maps/GoldenrodcityGates.asm"
SECTION "GoldenrodcityGates Blockdata", ROMX
GoldenrodcityGates_BlockData: INCBIN "maps/GoldenrodcityGates.blk"


SECTION "Route36_Underground_Path", ROMX
INCLUDE "maps/Route36_Underground_Path.asm"
SECTION "Route36_Underground_Path Blockdata", ROMX
Route36_Underground_Path_BlockData: INCBIN "maps/Route36_Underground_Path.blk"


SECTION "ROUTE33_GATES", ROMX
INCLUDE "maps/ROUTE33_GATES.asm"
SECTION "ROUTE33_GATES Blockdata", ROMX
ROUTE33_GATES_BlockData: INCBIN "maps/ROUTE33_GATES.blk"


SECTION "MAHOGANYGATES", ROMX
INCLUDE "maps/MAHOGANYGATES.asm"
SECTION "MAHOGANYGATES Blockdata", ROMX
MAHOGANYGATES_BlockData: INCBIN "maps/MAHOGANYGATES.blk"


SECTION "BLACKTHORNGATES", ROMX
INCLUDE "maps/BLACKTHORNGATES.asm"
SECTION "BLACKTHORNGATES Blockdata", ROMX
BLACKTHORNGATES_BlockData: INCBIN "maps/BLACKTHORNGATES.blk"


SECTION "ECRUTEAKGATES", ROMX
INCLUDE "maps/ECRUTEAKGATES.asm"
SECTION "ECRUTEAKGATES Blockdata", ROMX
ECRUTEAKGATES_BlockData: INCBIN "maps/ECRUTEAKGATES.blk"


SECTION "LAVENDERTOWNGATES", ROMX
INCLUDE "maps/LAVENDERTOWNGATES.asm"
SECTION "LAVENDERTOWNGATES Blockdata", ROMX
LAVENDERTOWNGATES_BlockData: INCBIN "maps/LAVENDERTOWNGATES.blk"


SECTION "ROUTE1GATES", ROMX
INCLUDE "maps/ROUTE1GATES.asm"
SECTION "ROUTE1GATES Blockdata", ROMX
ROUTE1GATES_BlockData: INCBIN "maps/ROUTE1GATES.blk"


SECTION "VIRIDIANCITYGATES", ROMX
INCLUDE "maps/VIRIDIANCITYGATES.asm"
SECTION "VIRIDIANCITYGATES Blockdata", ROMX
VIRIDIANCITYGATES_BlockData: INCBIN "maps/VIRIDIANCITYGATES.blk"


SECTION "ROUTE25GATES", ROMX
INCLUDE "maps/ROUTE25GATES.asm"
SECTION "ROUTE25GATES Blockdata", ROMX
ROUTE25GATES_BlockData: INCBIN "maps/ROUTE25GATES.blk"


SECTION "CERULEANCITYGATES", ROMX
INCLUDE "maps/CERULEANCITYGATES.asm"
SECTION "CERULEANCITYGATES Blockdata", ROMX
CERULEANCITYGATES_BlockData: INCBIN "maps/CERULEANCITYGATES.blk"


SECTION "ROUTE12GATES", ROMX
INCLUDE "maps/ROUTE12GATES.asm"
SECTION "ROUTE12GATES Blockdata", ROMX
ROUTE12GATES_BlockData: INCBIN "maps/ROUTE12GATES.blk"


SECTION "ROUTE8GATES", ROMX
INCLUDE "maps/ROUTE8GATES.asm"
SECTION "ROUTE8GATES Blockdata", ROMX
ROUTE8GATES_BlockData: INCBIN "maps/ROUTE8GATES.blk"


SECTION "CELADONCITYGATES", ROMX
INCLUDE "maps/CELADONCITYGATES.asm"
SECTION "CELADONCITYGATES Blockdata", ROMX
CELADONCITYGATES_BlockData: INCBIN "maps/CELADONCITYGATES.blk"


SECTION "SURFHOUSE", ROMX
INCLUDE "maps/SURFHOUSE.asm"
SECTION "SURFHOUSE Blockdata", ROMX
SURFHOUSE_BlockData: INCBIN "maps/SURFHOUSE.blk"


SECTION "BLACKTHORNUNDERGROUND", ROMX
INCLUDE "maps/BLACKTHORNUNDERGROUND.asm"
SECTION "BLACKTHORNUNDERGROUND Blockdata", ROMX
BLACKTHORNUNDERGROUND_BlockData: INCBIN "maps/BLACKTHORNUNDERGROUND.blk"


SECTION "MahoganyExtraHouse", ROMX
INCLUDE "maps/MahoganyExtraHouse.asm"
SECTION "MahoganyExtraHouse Blockdata", ROMX
MahoganyExtraHouse_BlockData: INCBIN "maps/MahoganyExtraHouse.blk"


SECTION "Ecruteak_Bonus_House", ROMX
INCLUDE "maps/Ecruteak_Bonus_House.asm"
SECTION "Ecruteak_Bonus_House Blockdata", ROMX
Ecruteak_Bonus_House_BlockData: INCBIN "maps/Ecruteak_Bonus_House.blk"


SECTION "MountainCaveGate", ROMX
INCLUDE "maps/MountainCaveGate.asm"
SECTION "MountainCaveGate Blockdata", ROMX
MountainCaveGate_BlockData: INCBIN "maps/MountainCaveGate.blk"


SECTION "BlackthornExtraHouse", ROMX
INCLUDE "maps/BlackthornExtraHouse.asm"
SECTION "BlackthornExtraHouse Blockdata", ROMX
BlackthornExtraHouse_BlockData: INCBIN "maps/BlackthornExtraHouse.blk"


SECTION "BlackthornExtraHouseBasement", ROMX
INCLUDE "maps/BlackthornExtraHouseBasement.asm"
SECTION "BlackthornExtraHouseBasement Blockdata", ROMX
BlackthornExtraHouseBasement_BlockData: INCBIN "maps/BlackthornExtraHouseBasement.blk"


SECTION "PEELEXTRAHOUSES", ROMX
INCLUDE "maps/PEELEXTRAHOUSES.asm"
SECTION "PEELEXTRAHOUSES Blockdata", ROMX
PEELEXTRAHOUSES_BlockData: INCBIN "maps/PEELEXTRAHOUSES.blk"


SECTION "ROUTE13FORESTGATES", ROMX
INCLUDE "maps/ROUTE13FORESTGATES.asm"
SECTION "ROUTE13FORESTGATES Blockdata", ROMX
ROUTE13FORESTGATES_BlockData: INCBIN "maps/ROUTE13FORESTGATES.blk"


SECTION "GRABANDMUNCH", ROMX
INCLUDE "maps/GRABANDMUNCH.asm"
SECTION "GRABANDMUNCH Blockdata", ROMX
GRABANDMUNCH_BlockData: INCBIN "maps/GRABANDMUNCH.blk"
