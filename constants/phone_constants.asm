	...
	const SPECIALCALL_ROBBED		 ;You got all 8 badges, get MASTERBALL
	const SPECIALCALL_ASSISTANT      ;Weird thing on TV
	const SPECIALCALL_WEIRDBROADCAST ;Children going missing
	const SPECIALCALL_SSTICKET		 ;Swing by my lab for a moment
	const SPECIALCALL_BIKESHOP		 ;SCARLET TV op
	const SPECIALCALL_WORRIED
	const SPECIALCALL_MASTERBALL 	 ;Elite Four Complete Call
